classdef DCASE2013_Scene_DevelopmentSet < DatasetBase
  ...
  methods
    function obj = DCASE2013_Scene_DevelopmentSet(data_path)            
        obj.name = 'DCASE2013-scene-development';
        ...
        obj.package_list = [ 
            struct('remote_package','http://c4dm.eecs.qmul.ac.uk/rdr/bitstream/handle/123456789/29/scenes_stereo.zip?sequence=1',...
                   'local_package',fullfile(obj.local_path, 'scenes_stereo.zip'),...
                   'local_audio_path',fullfile(obj.local_path, 'scenes_stereo')),                
        ];            
    end
